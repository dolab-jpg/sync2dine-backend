...
export function buildOfferTermsPayload(): Record<string, unknown> {
  ...
  return {
    ...
    usps: {
      ...
      atmosphere: [
        'Exclusive soundtrack created for that venue from their tastes, brand, and keywords — not Spotify, not a shared playlist',
        'Match guest seating/room atmosphere separately from kitchen / back-of-house mood',
        'Owner-directed announcements: specials, birthday parties, catering, opening/closing, promos on a controllable schedule',
        'In-venue offers that lift spend and reviews (e.g. free dip for a review + photo share)',
        'Staff training modules that play over multiple weeks while service continues — motivation, customer service, and output trained together',
        'Proven track record: Atmosphere has helped venues increase sales by shaping the guest environment and promoting relevant offers — cite as evidence, never invent ROI % or guarantee identical results for this prospect',
        'Only strategic venue-audio management of its kind in England — room, messaging, and staff development as one system',
      ],
    },
    spokenHint,
  };
