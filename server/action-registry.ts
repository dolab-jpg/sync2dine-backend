...
export const PHONE_ACTION_REGISTRY: ActionRegistryEntry[] = [
  ...
  { name: 'getLeadBrief', channels: ['vapi_phone', 'realtime_phone', 'cynthia_chat'], roles: ['staff', 'manager', 'super_admin'], risk: 'read', requiresPin: true, requiresConfirmation: false, idempotent: true },
  { name: 'addLeadNote', channels: ['vapi_phone', 'realtime_phone', 'cynthia_chat'], roles: ['staff', 'manager', 'super_admin'], risk: 'low_write', requiresPin: true, requiresConfirmation: false, idempotent: false },
  { name: 'listPendingCallbacks', channels: ['vapi_phone', 'realtime_phone', 'cynthia_chat'], roles: ['staff', 'manager', 'super_admin'], risk: 'read', requiresPin: true, requiresConfirmation: false, idempotent: true },
  ...
  { name: 'getCampaignProgress', channels: ['cynthia_chat'], roles: ['staff', 'manager', 'super_admin'], risk: 'read', requiresPin: false, requiresConfirmation: false, idempotent: true },
