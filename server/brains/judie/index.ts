...
/** Inbound open: short brand line only. sayToday is for soft upsell later ù not firstMessage. */
...
export const judieBrain: BrainPackage = {
  ...
  buildSession(input: BrainBuildInput): BrainSession {
    ...
    // Diner-only tool pack (not the full customer+CRM catalog) ó keeps Vapi turn latency low.
